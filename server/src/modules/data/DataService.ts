...
export class ServiceData {
    ...
    async recreateBook(name, info, year, cover_img, access_key, covers20) {
        ...
        if (!book) {
            ...
            dto.info = info;
            dto.year = year;
            dto.cover_img_path = covers20[cover_img];
    ...
    async lunchBooksAuthors(covers20, authors3) {
        ...
        await this.recreateBook('Book1', 'Book Description 1', 1999, covers20[0].id, 'book_key_1', covers20);
        await this.recreateBook('Book2', 'Book Description 2', 1995, covers20[1].id, 'book_key_2', covers20);
        await this.recreateBook('Book3', 'Book Description 3', 2001, covers20[2].id, 'book_key_3', covers20);
        await this.recreateBook('Book4', 'Book Description 4', 2003, covers20[3].id, 'book_key_4', covers20);
        await this.recreateBook('Book5', 'Book Description 5', 2004, covers20[4].id, 'book_key_5', covers20);
        await this.recreateBook('Book6', 'Book Description 6', 2001, covers20[5].id, 'book_key_6', covers20);
        await this.recreateBook('Book7', 'Book Description 7', 2010, covers20[6].id, 'book_key_7', covers20);
        await this.recreateBook('Book8', 'Book Description 8', 1992, covers20[7].id, 'book_key_8', covers20);
        await this.recreateBook('Book9', 'Book Description 9', 1995, covers20[8].id, 'book_key_9', covers20);
        await this.recreateBook('Book10', 'Book Description 10', 2011, covers20[9].id, 'book_key_10', covers20);
        await this.recreateBook('Book11', 'Book Description 11', 1999, covers20[10].id, 'book_key_11', covers20);
        await this.recreateBook('Book12', 'Book Description 12', 1995, covers20[11].id, 'book_key_12', covers20);
        await this.recreateBook('Book13', 'Book Description 13', 1998, covers20[12].id, 'book_key_13', covers20);
        await this.recreateBook('Book14', 'Book Description 14', 1992, covers20[13].id, 'book_key_14', covers20);
        await this.recreateBook('Book15', 'Book Description 15', 2003, covers20[14].id, 'book_key_15', covers20);
        await this.recreateBook('Book16', 'Book Description 16', 2001, covers20[15].id, 'book_key_16', covers20);
        await this.recreateBook('Book17', 'Book Description 17', 2005, covers20[16].id, 'book_key_17', covers20);
        await this.recreateBook('Book18', 'Book Description 18', 2002, covers20[17].id, 'book_key_18', covers20);
        await this.recreateBook('Book19', 'Book Description 19', 2007, covers20[18].id, 'book_key_19', covers20);
        await this.recreateBook('Book20', 'Book Description 20', 1998, covers20[19].id, 'book_key_20', covers20);
        await this.recreateBook('Book21', 'Book Description 21', 1993, covers20[0].id, 'book_key_21', covers20);
        await this.recreateBook('Book22', 'Book Description 22', 2013, covers20[1].id, 'book_key_22', covers20);
        await this.recreateBook('Book23', 'Book Description 23', 1992, covers20[2].id, 'book_key_23', covers20);
        await this.recreateBook('Book24', 'Book Description 24', 1996, covers20[3].id, 'book_key_24', covers20);
        await this.recreateBook('Book25', 'Book Description 25', 1998, covers20[4].id, 'book_key_25', covers20);
        await this.recreateBook('Book26', 'Book Description 26', 1992, covers20[5].id, 'book_key_26', covers20);
        await this.recreateBook('Book27', 'Book Description 27', 2003, covers20[6].id, 'book_key_27', covers20);
        await this.recreateBook('Book28', 'Book Description 28', 2001, covers20[7].id, 'book_key_28', covers20);
        await this.recreateBook('Book29', 'Book Description 29', 2005, covers20[8].id, 'book_key_29', covers20);
        await this.recreateBook('Book30', 'Book Description 30', 2002, covers20[9].id, 'book_key_30', covers20);
        ...
        await this.recreateBook('Book31', 'Book Description 31', 2007, covers20[10].id, 'book_key_31', covers20);
        await this.recreateBook('Book32', 'Book Description 32', 1998, covers20[11].id, 'book_key_32', covers20);
        await this.recreateBook('Book33', 'Book Description 33', 1993, covers20[12].id, 'book_key_33', covers20);
        await this.recreateBook('Book34', 'Book Description 34', 2013, covers20[13].id, 'book_key_34', covers20);
        await this.recreateBook('Book35', 'Book Description 35', 1992, covers20[14].id, 'book_key_35', covers20);
        await this.recreateBook('Book36', 'Book Description 36', 1996, covers20[15].id, 'book_key_36', covers20);
        await this.recreateBook('Book37', 'Book Description 37', 1996, covers20[16].id, 'book_key_37', covers20);
        await this.recreateBook('Book38', 'Book Description 38', 1997, covers20[17].id, 'book_key_38', covers20);
        await this.recreateBook('Book39', 'Book Description 39', 2003, covers20[18].id, 'book_key_39', covers20);
        await this.recreateBook('Book40', 'Book Description 40', 2001, covers20[19].id, 'book_key_40', covers20);
        await this.recreateBook('Book41', 'Book Description 41', 2003, covers20[5].id, 'book_key_41', covers20);
