...
const MainPage = ({ selectedItem, setSelectedItem, navigator }) => {
    ...
    const authorItems = [
        { id: 1, name: "Author1", info: "Author Description 1", age: 1999, photo: AuthorImage1 },
        { id: 2, name: "Author2", info: "Author Description 2", age: 2000, photo: AuthorImage2 },
        { id: 3, name: "Author3", info: "Author Description 3", age: 2001, photo: AuthorImage3 },
        { id: 4, name: "Author4", info: "Author Description 4", age: 2002, photo: AuthorImage1 },
        { id: 5, name: "Author5", info: "Author Description 5", age: 2003, photo: AuthorImage2 },
        { id: 6, name: "Author6", info: "Author Description 6", age: 2004, photo: AuthorImage3 },
        { id: 7, name: "Author7", info: "Author Description 7", age: 2005, photo: AuthorImage1 },
        { id: 8, name: "Author8", info: "Author Description 8", age: 2006, photo: AuthorImage2 },
        { id: 9, name: "Author9", info: "Author Description 9", age: 2007, photo: AuthorImage3 },
        { id: 11, name: "Author11", info: "Author Description 11", age: 1999, photo: AuthorImage1 },
        { id: 12, name: "Author12", info: "Author Description 12", age: 2000, photo: AuthorImage2 },
        { id: 13, name: "Author13", info: "Author Description 13", age: 2001, photo: AuthorImage3 },
        { id: 14, name: "Author14", info: "Author Description 14", age: 2002, photo: AuthorImage1 },
        { id: 15, name: "Author15", info: "Author Description 15", age: 2003, photo: AuthorImage2 },
        { id: 16, name: "Author16", info: "Author Description 16", age: 2004, photo: AuthorImage3 },
        { id: 17, name: "Author17", info: "Author Description 17", age: 2005, photo: AuthorImage1 },
        { id: 18, name: "Author18", info: "Author Description 18", age: 2006, photo: AuthorImage2 },
        { id: 19, name: "Author19", info: "Author Description 19", age: 2007, photo: AuthorImage3 },
        { id: 21, name: "Author21", info: "Author Description 21", age: 1999, photo: AuthorImage1 },
        { id: 22, name: "Author22", info: "Author Description 22", age: 2000, photo: AuthorImage2 },
        { id: 23, name: "Author23", info: "Author Description 23", age: 2001, photo: AuthorImage3 },
        { id: 24, name: "Author24", info: "Author Description 24", age: 2002, photo: AuthorImage1 },
        { id: 25, name: "Author25", info: "Author Description 25", age: 2003, photo: AuthorImage2 },
        { id: 26, name: "Author26", info: "Author Description 26", age: 2004, photo: AuthorImage3 },
        { id: 27, name: "Author27", info: "Author Description 27", age: 2005, photo: AuthorImage1 },
        { id: 28, name: "Author28", info: "Author Description 28", age: 2006, photo: AuthorImage2 },
        { id: 29, name: "Author29", info: "Author Description 29", age: 2007, photo: AuthorImage3 }
    ]
